...
joint5 = sim.send_hinge_joint(first_body_id=leg3,second_body_id=shin3,
                              x=0.75,y=0,z=1,n1=0,n2=1,n3=0)
joint6 = sim.send_hinge_joint(first_body_id=leg4,second_body_id=shin4,
                              x=-0.75,y=0,z=1,n1=0,n2=1,n3=0)
joint7 = sim.send_hinge_joint(first_body_id=leg2,second_body_id=shin2,
                              x=0,y=0.75,z=1,n1=1,n2=0,n3=0)
joint8 = sim.send_hinge_joint(first_body_id=leg1,second_body_id=shin1,
                              x=0,y=-0.75,z=1,n1=1,n2=0,n3=0)
